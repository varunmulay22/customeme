...
const initialState = {
  toptext: "Edit Meme Header",
  bottomtext: "Edit Meme Footer",
  isTopDragging: false,
...
class MainPage extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
          <div className="bar">
            <h1 className = "nav-header">CustoMeme</h1>
            <p>
              Create your own custom memes.
              Edit the Header and Footer.
              Go ahead and Download them <em>MemeMASTERS!</em>
            </p>
          </div>
        ...
        <Modal className="meme-gen-modal" isOpen={this.state.modalIsOpen}>
          <ModalHeader toggle={this.toggle}>Too Much editing</ModalHeader>
          <ModalBody>
            <svg
              width={newWidth}
              id="svg_ref"
            ...
            <div className="meme-form">
              ...
              <button onClick={() => this.convertSvgToImage()} className="btn btn-warning">Download Meme!</button>
            </div>
          </ModalBody>
        </Modal>
      </div>
